...
- ocr: 사용자가 **문서/서류의 텍스트 내용을 읽어달라거나 확인해달라는 경우**. 처방전, 신분증, 영수증, 계약서 등 텍스트가 있는 문서를 사진으로 보내려는 의도.
  → 주의: 단순 정보 문의는 faq. 실물 문서를 직접 찍어 내용 확인이 필요한 경우에만 ocr.
